...
/**
 * Tela de cadastro de professores do sistema.
 * 
 * <p>
 * Permite inserir nome, contato, CPF, data de nascimento, campus, título
 * acadêmico e salário. Realiza validações, formata campos automaticamente
 * e envia os dados para o serviço responsável pelo salvamento.
 * </p>
 * 
 * <p>
 * Esta tela utiliza {@link ProfessorService} para validações e operações
 * de negócio referentes ao professor.
 * </p>
 */
...
public class CadastroProfessor extends javax.swing.JFrame {
    ...
    /**
     * Construtor padrão da tela de cadastro de professor.
     *
     * <p>
     * Inicializa componentes gráficos, formata campos com máscaras padrão
     * e define o botão "Confirmar" como ação padrão da janela (ENTER).
     * </p>
     *
     * @throws ParseException caso alguma máscara de formatação apresente erro.
     */
     ...
     *
     * <p>
     * Método gerado automaticamente pelo Editor de Formulários do NetBeans.
    ...
    /**
     * Aplica máscaras de formatação aos campos de CPF, contato e salário.
     *
     * @throws ParseException caso alguma máscara seja inválida.
     */
     ...
     *
     * <p>
     * Realiza validações nos campos, monta um objeto {@link Professor},
     * e solicita ao serviço que salve o cadastro.
     * </p>
     *
    ...
    private void bConfirmarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bConfirmarActionPerformed
        try {
            ...
            if (this.idade.getDate() == null) {
                JOptionPane.showMessageDialog(rootPane, "Data de nascimento é obrigatória.", "Erro",
            ...
            JOptionPane.showMessageDialog(rootPane, "Professor cadastrado com sucesso!", "Sucesso",
    ...
    /**
     * Método principal para execução da tela isoladamente.
     *
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroProfessor.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
