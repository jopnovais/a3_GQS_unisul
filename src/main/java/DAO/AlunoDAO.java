...
public class AlunoDAO {
    ...
    public void save(Aluno aluno) {
        ...
        try (Connection conn = ConnectionFactory.createConnectionToMySQL(); PreparedStatement pstm = conn.prepareStatement(sql)) {
    ...
    public List<Aluno> getAlunos() {
        ...
        try (Connection conn = ConnectionFactory.createConnectionToMySQL(); PreparedStatement pstm = conn.prepareStatement(sql); ResultSet rset = pstm.executeQuery()) {
            while (rset.next()) {
